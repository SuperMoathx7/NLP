...
let lang_model = {
    ...
    continuingConversation: {
        en: "Continuing our conversation about",
        ar: "مواصلة محادثتنا حول"
    },
    askingAbout: {
        en: "You asked about",
        ar: "سألت عن"
    ...
    basedOnReviews: {
        en: "Based on user reviews",
        ar: "بناءً على مراجعات المستخدمين"
    },
    supportingEvidence: {
        en: "Supporting Reviews:",
        ar: "مراجعات داعمة:"
    },
    conversationError: {
        en: "Sorry, there was an error processing your question. Could you rephrase it?",
        ar: "عذراً، حدث خطأ أثناء معالجة سؤالك. يمكنك إعادة صياغة السؤال؟"
    },
    noAdditionalReviews: {
        en: "Sorry, I don't have additional reviews for the {phoneName} regarding {feature}.",
        ar: "عذراً، لا توجد مراجعات إضافية متاحة للـ {phoneName} حول {feature}."
    },
    comparison: {
        en: "Comparison:",
        ar: "مقارنة:"
    ...
    translatingReviews: {
        en: "Translating reviews...",
        ar: "جارٍ ترجمة المراجعات..."
    },
    reviewTranslationError: {
        en: "Could not translate reviews, showing original text.",
        ar: "لم يتمكن من ترجمة المراجعات، عرض النص الأصلي."
    }
};
...
function switchLanguage(new_lang) {
    ...
    // Reset conversation context when language changes
