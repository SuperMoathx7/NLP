...
function showPhones(final_phones, maxPoint, criteria) {
    counter += 10
    const responseDiv = document.getElementById('response');
    let htmlResponse = `<h4 class="mb-3" id="result-message">${getResultMessage(criteria, maxPoint)}</h4>`;
            ...
            <div class="phone-card card border-0 shadow-sm hover-shadow transition-all mb-3">
                <div class="card-body p-4">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        ${phone.Screen_Inches ? `<li class="d-flex align-items-center mb-2"><span class="badge bg-light text-dark me-2"><i class="fas fa-mobile me-1"></i> Screen Size:</span> ${phone.Screen_Inches} inches</li>` : ''}
                        ${phone.Weight_g ? `<li class="d-flex align-items-center mb-2"><span class="badge bg-light text-dark me-2"><i class="fas fa-weight me-1"></i> Weight:</span> ${phone.Weight_g} g</li>` : ''}
