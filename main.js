...
const apiKey = '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';
...
Take a deep breath and work on this problem step-by-step.`;
    ...
    const isFollowUp = await checkConversationContinuation(translatedQuery);
    
    if (isFollowUp) {
        await handleFollowUpQuestion(translatedQuery);
    } else {
...
Example replies:
if the user wrote in english: “I help with phone specs only (price, RAM, CPU, etc.). Please share your preferences.”
if the user wrote in arabic: "أساعدك حسب المواصفات فقط (السعر، الرام، المعالج...). من فضلك أرسل تفضيلاتك."
